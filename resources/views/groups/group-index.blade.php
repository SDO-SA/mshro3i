<div class="flex flex-col items-center justify-center md:h-[450px] xl:h-[400px] 2xl:h-[500px]">
    <img src="img/notingroup.svg" alt="" class="w-auto h-[400px] 2xl:h-[600px] xl:h-[500px] md:h-[500px]">
        <h2 class="text-center font-semibold text-2xl text-gray-800 sm:text-4xl dark:text-gray-200 leading-tight">{{ __('app.no_group') }}</h2>
            <div class="flex justify-center mt-4 md:mt-6 mb-16">
