<div class="flex flex-col items-center justify-center h-96">
    ...
    <div class="flex mt-4 md:mt-6">
        <a href="{{ url('/groups/create-group') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-indigo-800 rounded-lg hover:bg-indigo-900 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('app.create_group') }}</a>
