...
<div class="flex items-center justify-center p-6">
    <div class="grid lg:grid-cols-3 md:grid-cols-1 w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">  
        {{-- Displaying Student name --}}
        <x-user-info label="Name">{{ $user->name }}</x-user-info>
        {{-- Displaying ID --}}
        <x-user-info label="University ID">{{ $user->university_id }}</x-user-info>
        {{-- Displaying E-mail --}}
