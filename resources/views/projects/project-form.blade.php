<x-guest-layout>
    <form method="POST" action="{{ route('createproject') }}" enctype="multipart/form-data">
        ...
        <!-- Name -->
        <div>
            <x-required-input for="name" :value="__('Project Name')" />
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus />
            <x-input-error :messages="$errors->get('name')" class="mt-2" />
        </div>

        <div class="mt-4">
            <x-required-input for="abstract" :value="__('Abstract')" />
        ...
        <div class="mt-4">
            <x-required-input for="projectfield" :value="__('Project Fields')" />
        ...
        <!-- Attachment -->
        <div class="mt-4">
            <x-required-input for="attachment" :value="__('Project Proposal')" />
