<x-app-layout>
    ...
    @if (count($assignments) <= 0)
            <div class="flex flex-col items-center justify-center h-auto">
                <img src="{{ asset('img/Exams-bro.svg') }}" alt="" class="lg:w-[500px] lg:h-[500px] sm:w-[250px] sm:h-[250px]">
                <h1 class="font-semibold text-2xl text-gray-800 sm:text-4xl dark:text-gray-200 leading-tight">{{__('app.no_assignments_available')}}</h1>
            </div>
    @else
