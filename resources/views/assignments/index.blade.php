                ...
                <tbody>
                    @foreach($assignments as $assignment)
                        <tr class="bg-white text-base border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <th scope="row" class="pr-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$assignment->id}}</th>
                            <td class="px-2 py-4 underline"><a href="{{route('assignments.show', $assignment->id)}}">{{$assignment->name}}</a></td>
