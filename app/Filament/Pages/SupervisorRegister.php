 ...
 * @property Form $form
 */
class SupervisorRegister extends SimplePage
{
     ...
     * @var view-string
     */
    protected static string $view = 'filament.pages.supervisor-register';
    ...
    protected function getDepartmentFormComponent(): Component
    {
        return Select::make('department_id')
            ...
            ->options(Department::all()->pluck('name_ar', 'id'))
            ->required()
            ->autofocus();
    }
    ...
    protected function getUserModel(): string
    {
        ...
        $authGuard = auth()->guard('supervisor');
